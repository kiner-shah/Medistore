...
${OBJECTDIR}/authentication.o: authentication.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/authentication.o authentication.cpp

${OBJECTDIR}/customer.o: customer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/customer.o customer.cpp

${OBJECTDIR}/file_mngr.o: file_mngr.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/file_mngr.o file_mngr.cpp

${OBJECTDIR}/linux_getch.o: linux_getch.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/linux_getch.o linux_getch.cpp
...
${OBJECTDIR}/sha512.o: sha512.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sha512.o sha512.cpp

${OBJECTDIR}/staff.o: staff.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/staff.o staff.cpp

${OBJECTDIR}/store.o: store.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/store.o store.cpp
...
${TESTDIR}/file_mngr_test.o: file_mngr_test.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/file_mngr_test.o file_mngr_test.cpp
...
${TESTDIR}/tests/newsimpletest1.o: tests/newsimpletest1.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/newsimpletest1.o tests/newsimpletest1.cpp
...
${OBJECTDIR}/authentication_nomain.o: ${OBJECTDIR}/authentication.o authentication.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/authentication_nomain.o authentication.cpp;\
	else  \
...
${OBJECTDIR}/customer_nomain.o: ${OBJECTDIR}/customer.o customer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/customer_nomain.o customer.cpp;\
	else  \
...
${OBJECTDIR}/file_mngr_nomain.o: ${OBJECTDIR}/file_mngr.o file_mngr.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/file_mngr_nomain.o file_mngr.cpp;\
	else  \
...
${OBJECTDIR}/linux_getch_nomain.o: ${OBJECTDIR}/linux_getch.o linux_getch.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/linux_getch_nomain.o linux_getch.cpp;\
	else  \
...
${OBJECTDIR}/sha512_nomain.o: ${OBJECTDIR}/sha512.o sha512.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sha512_nomain.o sha512.cpp;\
	else  \
...
${OBJECTDIR}/staff_nomain.o: ${OBJECTDIR}/staff.o staff.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/staff_nomain.o staff.cpp;\
	else  \
...
${OBJECTDIR}/store_nomain.o: ${OBJECTDIR}/store.o store.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/store_nomain.o store.cpp;\
	else  \
